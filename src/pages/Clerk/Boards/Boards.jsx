        ...
        <div>
            ...
            <div className='border-[#7C884C] border-2 bg-[#7C884C] p-3 rounded-2xl'>
                ...
                <div className="tabs tabs-lift">
                    <label className="tab">
                        <input type="radio" name="clerk_board_tabs" />
                        <TbMailDown className='h-6 w-6' />
                        <h3 className='ml-2 text-xl font-semibold'>Store Boards</h3>
                    </label>
                    ...
                    <label className="tab">
                        ...
                        <h3 className='ml-2 text-xl font-semibold'>Internet Boards</h3>
                    </label>
                    <div className="tab-content bg-base-100 border-base-300 p-6">
                        Internet Boards ....
                    </div>
                    ...
                    <label className="tab">
                        ...
                        <h3 className='ml-2 text-xl font-semibold'>Other Boards</h3>
                    </label>
                    <div className="tab-content bg-base-100 border-base-300 p-6">
                        Other Boards ...
                    </div>
